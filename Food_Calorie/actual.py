...
while not done:
    ...
    if choice == 4:
        ...
        print()
        print("Carbs consumed in Dinner : " + str(carbs_dinner))
    ...
    if choice == 5:
        ...
        calories_addl = 0
        for a in range(len(calories_list)):
            calories_addl += calories_list[a]
        fat_addl = 0
        for b in range(len(fat_list)):
            fat_addl += fat_list[b]
        protein_addl = 0
        for c in range(len(protein_list)):
            protein_addl += protein_list[c]
        carbs_addl = 0
        for d in range(len(carbs_list)):
            carbs_addl += carbs_list[d]
        print('''You have consumed the Additional following :- ''')
        print()
        '''
        prints in the format 
        1) food item
        ...
        for j in range(len(name_list)):
            ...
            print()
        print()
        print("Calories consumed Additionally : " + str(calories_addl))
        print()
        print("Protein consumed Additionally : " + str(protein_addl))
        print()
        print("Fat consumed Additionally : " + str(fat_addl))
        print()
        print("Carbs consumed Additionally : " + str(carbs_addl))
